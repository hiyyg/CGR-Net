...
data_arg.add_argument(
    "--data_tr", type=str, default='/home/424073703/Dataset/yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default='/home/424073703/Dataset/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default='/home/424073703/Dataset/yfcc-sift-2000-test.hdf5', help=""
...
train_arg.add_argument(
    ...
    "batch size")
train_arg.add_argument(
    "--gpu_id", type=str, default='04', help='id(s) for CUDA_VISIBLE_DEVICES')
train_arg.add_argument(
...
train_arg.add_argument(
    "--log_base", type=str, default="/home/424073703/szw/CLNet_map_1/core/log/", help=""
...
test_arg.add_argument(
    "--model_path", type=str, default="/home/424073703/szw/CLNet_map_1/core/log/train", help=""
